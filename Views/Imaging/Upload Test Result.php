				...
				<span style="position:absolute; top:215px; width:798px;">
					<div id="welcome" style="padding-left:20px; padding-right:10px; padding-top:20px; padding-bottom:10px;">
						...
						<div class="content">
							...
							<br>
							<form action="../../controller/patient_record.action.php" name="parent" id="parent" method="post"
								enctype="multipart/form-data" onsubmit="return check('parent')">		
								<center>
								<table id="dataTable" border="0" cellpadding="5">
									<input type="hidden" name="imaging" value="1">
									<tr>
										<th>Patient Name</th>
										<td><input type="text" name="patientName"  disabled=true title="Patient Name" id="patientName"><input type="hidden" name="patientId" id="patientId">
										<input type="button" onclick="search_patient()" value="Search">
										</td>
									</tr>
									<tr>
										<th>Doctor</th><td>
										<input type="text" name="doctorName" disabled=true id="doctorName" title="Doctor">
										<input type="hidden" name="accountId" id="doctorId">
										<input type="button" onclick="search_doctor()" value="Search">
										</td>
									</tr>
									<tr>
										<th>Date Recorded</th><td><input id="daterep" title="Date Recorded" class="validate['required','number']" onClick="ds_sh(this)" name="dateStored" size="20" readonly="readonly" style="cursor: text" /></td>
									</tr>
								<!--	<tr>
								...
								-->
									<tr>
										<th>File Upload</th><td><input title="File Upload"type="file" name="file" id="file"></td>
									</tr>
								</table>
								</center>
								<center>
