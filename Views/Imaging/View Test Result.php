					...
					<div id="welcome" style="padding-left:20px; padding-right:10px; padding-top:20px; padding-bottom:10px;">
						...
						<div class="content">
							...
							<tr>
								...
								<td><center>
									<?php
										$files = $pr->check_doc_img($row['patientId']."=".$row['dateStored']."/");
										if($files!=""){				
								...
								<td>
									<center>
									<a href="Edit Test Result.php?imaging&id=<?php echo $row['id']; ?>&patientId=<?php echo $row['patientId']; ?>&dateStored=<?php echo $row['dateStored'];?>"><img src="../../image/update.png"></a>
									<a href="Delete Test Result.php?imaging&id=<?php echo $row['id']; ?>&patientId=<?php echo $row['patientId']; ?>&dateStored=<?php echo $row['dateStored'];?>"><img src="../../image/delete.png"></a>
									</center>
								</td>-->
							</tr>
							<?php
