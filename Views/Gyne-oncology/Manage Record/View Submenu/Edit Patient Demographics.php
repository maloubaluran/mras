...
<head>
    ...
    <title>BRYCeC - Edit Patient Demographics</title>
			...
			<span style="position:absolute; top:215px; width:798px;">
				<div id="welcome" style="padding-left:20px; padding-right:10px; padding-top:10px; padding-bottom:10px;">
					...
					<form action="" class="searchform">
						<br><br>
						<p align="center" style="color:#BB5FB3; font-size:18px;"><b>Name:</b> &nbsp; <input type="text" name="userInfo" class="textbox" />
						...
						<?php if(isset($_GET['search'])){
							...
							if(mysql_num_rows($user)>0){		
							 while($row = mysql_fetch_array($user)){?>
								<tr>
								<td><a href="../Views/Patient Demographic Record.php?id=<?php echo $row['patientID'];?>"><input type="submit" name="edit" class="art-button-wrapper" value="Edit" /></a></td>
