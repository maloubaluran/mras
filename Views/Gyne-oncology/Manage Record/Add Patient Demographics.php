			...
			<div class="art-Header-png"></div>
				...
				<span style="position:absolute; top:215px; width:798px;">
					<div id="welcome" style="padding-left:20px; padding-right:10px; padding-top:20px; padding-bottom:10px;">
						...
						<ol id="toc">
							<li><a href="#patientrecord"><span>ADD PATIENT DEMOGRAPHICS</span></a></li>
						</ol>
					
						<div class="content" id="page-1">
							<center><div class="art-PostMetadataHeader">
								<h2 class="art-PostHeader">
								<center>ADD PATIENT DEMOGRAPHICS</center>
								</h2>
							</div></center>
							<hr noshade size="3" style="margin-left:200px;" width="300px" />
								...
								<form action="../../../controller/patient.action.php" method="post" name="form1">
									<center>
									<table>
									<tr><td>First Name: </td><td><input type="text" name="f_name" ></td>
									<tr><td>Middle Name: </td><td><input type="text" name="m_name"></td>
									<tr><td>Last Name: </td><td><input type="text" name="l_name"></td>
									<tr></tr>
									<tr><td>
									&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
 									MM: </td><td><select name="month" size="1">
										<script type="text/javascript">
										for(var i=1;i<13;i++)
									...
									<tr><td>Age: </td><td><input id="age" name="age" size="2" onKeyPress='return numbersonly(event, false)' onclick="calage()" > years</td>
									<tr><td>Height: </td><td><input type="text" name="height" ></td>
									<tr><td>Weight: </td><td><input type="text" name="weight" ></td>
									<tr><td>Civil Status: </td><td><input type="text" name="civilstatus" ></td>
									<tr><td>Home Address: </td><td><input type="text" name="homeadd" ></td>
									<tr><td>Contact No: </td><td><input type="text" name="telno" ></td>
									<tr><td>Office Address: </td><td><input type="text" name="officeadd" ></td>
									<tr><td>Contact No: </td><td><input type="text" name="telno2"></td>
									<tr><td>Occupation: </td><td><input type="text" name="occupation" ></td>
									<br>				
