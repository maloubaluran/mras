					 ...
					 <ul class="art-menu">								
						...
						<li>
							...
							<ul style="width:230px;">
								<li>
									<a href="Manage Record/Add Patient Demographics.php"><span class="l"></span><span class="r"></span><span class="t">Add Patient Demographics</span></a>
								</li>
								<li>
									<a href="Manage Record/Add Patient Medical History.php"><span class="l"></span><span class="r"></span><span class="t">Add Patient Medical History</span></a>
								</li>
								<li>
									<a href="Manage Record/View Patient Record.php"><span class="l"></span><span class="r"></span><span class="t">View Patient Record</span></a>
								</li>
								<li>
									<a href="Manage Record/View Patient Medical History.php"><span class="l"></span><span class="r"></span><span class="t">View Patient Medical History</span></a>
								</li>
							</ul>
						</li>							
                		<li>
				...
				<span style="position:absolute; top:215px; width:798px;">
					<div id="welcome" style="padding-left:20px; padding-right:10px; padding-top:10px; padding-bottom:10px;">
						<img src="../../Images/welcome.png"/>
							...
							<p align="justify" style="margin-left:10px; margin-right:10px;">&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; <strong>MRAS: Medical Records Archiving System</strong> is a system that will monitor the medical services that each cervical cancer patient undergo, provide a correct patient information, make the recording of all patient information more organized and generate automated reports of patients.</p>
